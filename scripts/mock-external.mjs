...
globalThis.fetch = async (url, init) => {
  ...
  if (u.startsWith('https://api.anthropic.com')) { const body = JSON.parse(init.body); const isJSON = /Devolvé SOLO un JSON/.test(body.messages.at(-1).content); return j({ content: [{ type: 'text', text: isJSON ? '{"hook":"Buen hook","retention":"Ok","cta":"Comentá IA","improve":"Probá X","score":72,"keyword":"IA","title":"Reel test","why":"w","onscreen":"o","body":"b","publish":"p"}' : '## Idea\n- Punto uno\n> "Hook"' }] }); }
